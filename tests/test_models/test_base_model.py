...
class TestClass(unittest.TestCase):
    ...
    def teardown(self):
        ...
        def test_create_istance(self):
            ...
            self.assertIstance(self.model, BaseModel)
            ...
            def test_save(self):
                ...
                self.assertTrue(
                '{}.{}'.format(tyoe(self.model).__name__, self.model.id)]
                )
                ...
                def test_create_instance_from_dict(sel):
                    ...
                    model_dict = {'id': '56d43177-cc5f-4d6c-a0c1-e167f8c27337',
                            ...
                            'update_at': '2017-09-28T21:03:54.052302',
                      'name': 'Holberton'}
